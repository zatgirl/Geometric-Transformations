...
public:
    ...
    static void line( Vector2 p1, Vector2 p2, float width );
    ...
    static void circle( float x, float y, float radius, int div, float width );
    static void circle( Vector2 pos, float radius, int div, float width);
